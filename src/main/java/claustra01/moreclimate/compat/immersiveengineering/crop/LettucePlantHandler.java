...
public class LettucePlantHandler extends WeightedPlantHandler {
    ...
    public static ItemStack itemSeeds = new ItemStack(FoodInit.seeds, 1, 13);
    public static ItemStack itemDrops = new ItemStack(FoodInit.crops, numDrops, 15);
    public static ItemStack blockDirt = new ItemStack(Blocks.DIRT);

    public LettucePlantHandler() {
        this.seed = new ComparableItemStack(itemSeeds, false, false);
        this.soil = new ComparableItemStack(blockDirt, false, false);
        this.crop = FoodInit.cropLettuce;
    }
